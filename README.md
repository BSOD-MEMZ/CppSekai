...
- **设置齐全**（H 键或选曲界面的设置按钮，分演奏 / 画面 / 判定 / 系统 / 账户五页）：音频偏移、音符速度、BGM / 音效音量、分辨率预设、窗口模式、帧率上限、播放进度条开关、AUTOPLAY 预览、判定窗口、严格 Flick 方向、失焦自动暂停、SMTC 汇报开关、昵称 / 学校 / 签名，全部持久化到 `userdata.json`。
